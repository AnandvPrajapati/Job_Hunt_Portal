      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© 2024 Yash Raval. All rights reserved.</p>
          </div>

          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/yashraval201" className="hover:text-gray-400" aria-label="Github">
            ...
            <a href="https://www.linkedin.com/in/yash-raval-1702fy" className="hover:text-gray-400" aria-label="LinkedIn">
